...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--image", required=True, help="Input image for SURF keypoint description.")
    ...
    # Detect:
    key_points, features = surf.detectAndCompute(image_grayscale, None)
    ...
    # Save description:
    with open(
        "SURF-description-{}.pkl".format(args["image"].split('/')[1]),
        "wb"
    ) as features_pkl:
