...
if __name__ == '__main__':
    ...
    parser.add_argument("-i", "--image", required=True, help="Input image for BRISK keypoints detection.")
    ...
    key_points, features = brisk.detectAndCompute(image_grayscale, None)
    ...
    # Save description:
    with open(
        "BRISK-description-{}.pkl".format(args["image"].split('/')[1]),
        "wb"
    ) as features_pkl:
